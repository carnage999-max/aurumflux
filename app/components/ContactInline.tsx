        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ background: '#0D2F44', borderRadius: '16px', padding: '2rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#e6b84f', marginBottom: '1.5rem' }}>Get in Touch</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                  <div style={{ background: '#e6b84f', borderRadius: '8px', padding: '0.75rem', flexShrink: 0 }}>
                  ...
                  <div>
                    ...
                    <a href="mailto:info@aurumfluxocean.com" style={{ color: 'white', fontSize: '1.125rem', textDecoration: 'none', transition: 'color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#e6b84f'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>
            ...
            {/* Investment Tiers */}
            <div style={{ background: '#0D2F44', borderRadius: '16px', padding: '2rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#e6b84f', marginBottom: '1.5rem' }}>Investment Tiers</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div style={{ background: '#284155', borderRadius: '8px', padding: '1rem', borderLeft: '4px solid #e6b84f' }}>
            ...
            {/* NDA Notice */}
            <div style={{ background: 'radial-gradient(circle at 30% 30%, #fff2b8 0%, #f7d774 20%, #e6b84f 45%, #ffd778 65%, #b8860b 100%)', borderRadius: '12px', padding: '1.5rem', boxShadow: '0 12px 20px rgba(0, 0, 0, 0.35), 0 4px 6px rgba(0, 0, 0, 0.25), inset 0 2px 4px rgba(255, 255, 255, 0.35), inset 0 -4px 6px rgba(0, 0, 0, 0.35)', border: '2px solid #b8860b' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                <svg style={{ width: '24px', height: '24px', color: '#0b1a2d', flexShrink: 0, marginTop: '0.25rem', filter: 'drop-shadow(0 1px 1px rgba(255, 255, 255, 0.3))' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
                <div>
                  <h4 style={{ color: '#0b1a2d', fontWeight: '700', marginBottom: '0.5rem', textShadow: '0 1px 1px rgba(255, 255, 255, 0.3), 0 -1px 1px rgba(0, 0, 0, 0.6)' }}>Confidential Information</h4>
                  <p style={{ color: '#1a1a1a', fontSize: '0.875rem', fontWeight: '600' }}>
          ...
          {/* Contact Form */}
          <div style={{ background: '#0D2F44', borderRadius: '16px', padding: '2rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)' }}>
            <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#e6b84f', marginBottom: '1.5rem' }}>Investor Interest Form</h3>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                <input
                  ...
                  id="nda"
                  required
                  style={{ marginTop: '0.25rem', width: '20px', height: '20px', accentColor: '#e6b84f' }}
                />
        ...
        <div style={{ borderTop: '1px solid #33546D', paddingTop: '2rem', paddingBottom: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href="#" style={{ color: '#9ca3af', fontSize: '0.875rem', textDecoration: 'none', transition: 'color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#e6b84f'} onMouseLeave={(e) => e.currentTarget.style.color = '#9ca3af'}>
                Privacy Policy
              </a>
              <a href="#" style={{ color: '#9ca3af', fontSize: '0.875rem', textDecoration: 'none', transition: 'color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#e6b84f'} onMouseLeave={(e) => e.currentTarget.style.color = '#9ca3af'}>
                Terms of Service
