  ...
  return (
    <section id="environmental" style={{ position: 'relative', background: '#284155', padding: '5rem 0 8rem' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
        ...
        {/* Zero Harm Pledge */}
        <div style={{ background: '#0D2F44', borderRadius: '16px', padding: '3rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', marginBottom: '3rem', textAlign: 'center', border: '4px solid #C39340' }}>
          <div style={{ display: 'inline-block', background: '#C39340', borderRadius: '50%', padding: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <h3 style={{ fontSize: '1.875rem', fontWeight: 'bold', color: '#C39340', marginBottom: '1rem' }}>"Zero Harm" Gold Extraction Pledge</h3>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
          ...
          <div style={{ background: '#33546D', borderRadius: '12px', padding: '2rem', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3)', transition: 'transform 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
            <div style={{ background: '#C39340', borderRadius: '50%', width: '64px', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem' }}>
              <svg style={{ width: '32px', height: '32px', color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
            </div>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'white', textAlign: 'center', marginBottom: '1rem' }}>Seawater-to-Seawater Closed Loop</h3>
          ...
          <div style={{ background: '#33546D', borderRadius: '12px', padding: '2rem', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3)', transition: 'transform 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
            ...
            <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'white', textAlign: 'center', marginBottom: '1rem' }}>AI-Based Adaptive Flow Rate</h3>
            <p style={{ color: '#d1d5db', textAlign: 'center' }}>
          ...
          <div style={{ background: '#33546D', borderRadius: '12px', padding: '2rem', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3)', transition: 'transform 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
            ...
            <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'white', textAlign: 'center', marginBottom: '1rem' }}>Marine Life Protection</h3>
            <p style={{ color: '#d1d5db', textAlign: 'center' }}>
